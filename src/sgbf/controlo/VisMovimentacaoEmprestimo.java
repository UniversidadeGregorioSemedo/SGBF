...
public class VisMovimentacaoEmprestimo implements Initializable {
    ...
    @FXML
    private Button botaoEmprestar,botaoCancelarReserva, botaoDevolverItem, botaoCancelar, botaoSair;
    @FXML
